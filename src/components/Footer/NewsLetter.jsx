  ...
  return (
    <div className="text-center pb-9">
      <h1 className="text-2xl font-semibold md:w-1/2 md:mx-auto leading-normal ">
        Subvscribe to our NewsLetter and get the latest Updates
      </h1>
      <p className="md:w-1/2 md:mx-auto pt-5 text-sm text-gray-600 leading-loose">
        we have hiking related blog so we can share our thoughts and rutinity in
        our blog that updated weekly. We will not span you, we promise.
      </p>
